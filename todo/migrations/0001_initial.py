# Generated by Django 6.1.1 on 2026-09-22 10:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_img', models.ImageField(blank=True, null=True, upload_to='UserImage')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tag_name', models.CharField(unique=True, verbose_name=30)),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='UserImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='todo.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Favorite', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='todo.favorite')),
